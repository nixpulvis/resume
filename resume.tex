...
\begin{itemize}
  ...
  \item
  \headerrow
    {\textbf{Partyshark Website (www.partyshark.org)}}
    {\textbf{Personal Project}}
  \headerrow
    {\emph{World of Warcraft Guild Website}}
    {\emph{2014 -- Current}}
  \begin{itemize*}
    \item
    Built a forum system in Rails to allow members to collaborate and share posts. This system
    uses the site's notion of permissions to allow threads to be limited to specific ranks.
    \item
    Designed a boss strategy section to allow specific members of the guild to explain in detail
    how to fight bosses.
    \item
    Built an application flow, to make applying to the guild simple and easy. Integrating with
    the Battle.net API to pull information about characters registered on the site.
  \end{itemize*}
\end{itemize}
