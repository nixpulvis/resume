...
\begin{itemize}
  ...
  \begin{itemize*}
    ...
    \item
    Planned and lead refactoring and dev tool efforts. This includes object
    model improvements, a CLI for managing Heroku, and more.
    \item
    Mentored our coops by providing deep code reviews, and spending time
