...
\begin{description*}
  \item[Languages:] Ruby, C/C++, Rust, LUA, and Racket. ECMAScript
  (JS), Python, Java, and Shell and many more...
  \item[Systems:] Git, GitHub, Postgres, Rails, UNIX, AVR/ARM, Linux, WoW
  (ask me about it).
\end{description*}
\end{indentsection}
...
\begin{itemize}
  ...
  \begin{itemize*}
    ...
    Kitchen's websites including bug fixes and technical infrastructure upgrades.
    \item
  ...
  \begin{itemize*}
    ...
    changes would affect a real build of the system. Reduced turnaround time,
  ...
  \begin{itemize*}
    ...
    \item
    Created a web based front-end for HOMER in Rails. This was the starting point
    for the next version of HOMER, and provided a proof of concept for how
...
\begin{itemize}
  ...
  \begin{itemize*}
    ...
    \item
    Courses TA'd: Fundamentals of Computer Science 1 (4 years).
  \end{itemize*}
\end{itemize}
